                                                ...
                                                <div class="Flex__Flex-fVJVYW bHipRv">
                                                    <form id="confirm_form" action="" method="POST">
                                                        ...
                                                        <div class="btn-otr">
                                                            ...
                                                            <input type="button" name="submit" value="<?= Lang::string('confirm-buy') ?>" class="Flex__Flex-fVJVYW ghkoKS buy-btc btn btn-primary" style="width: auto;display: inline-block;" onclick="order_ajax();"/>
                                                            </span>
                                                            <span>
                                                        ...
                                                        <div class="btn-otr">
                                                            ...
                                                            <input type="button" name="submit" value="<?= Lang::string('confirm-sale') ?>" class="Flex__Flex-fVJVYW ghkoKS buy-btc btn btn-primary" style="width: auto;display: inline-block;padding: 12px 30px;" onclick="order_ajax();"/>                                                             
                                                            </span>
                                                            <span>
                                                                <!-- <input id="cancel_transaction" type="submit" name="dont" value="<?= Lang::string('confirm-back') ?>" class="Flex__Flex-fVJVYW ghkoKS buy-btc" style="width: auto;display: inline-block;float: right;padding: 12px 30px;" /> -->
