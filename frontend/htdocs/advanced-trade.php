            ...
            ?>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 no-padding">
                        <div>
                            ...
                            <div id="chart_div" style="width: 96%; height: 30%;"></div>  
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="submit_form_div">
    ...
    <script>
                ...
                function order_ajax_buy() 
                {
                    ...
                    var buy_market_price_new=$('#buy_market_price_new').val();                    
                    var is_referral=$('#is_referral_new').val();   
                    var bonus_amount=$('#bonus_amount_new').val();   
                    var buy_all=$('#buy_all').val();   
                    var ischecked= $('#buy_stop').is(':checked');
                    if(ischecked) 
                    { 
                        var buy_stop=1; 
                    ...
                    { 
                        var buy_stop=''; 
                        var buy_stop_price=0;   
                    }
                    var ischeckedbl= $('#buy_limit').is(':checked');
                    if(ischeckedbl)
                    {
                    ...
                    $.ajax ({
                       ...
                       data: {                                
                                ...
                                'buy_price':buy_price,
                                'buy_market_price':buy_market_price_new,
                       ...
                       success: function(respon)
                       {
                        if(respon==1)
                        {
                            ...
                            $.ajax ({
                               type: "POST",
                               url: 'get-trade-order-respon.php',
                               data: {                                
                                        'currency_id':currency_id,
                                        'c_currency_id':c_currency_id,
                                        'trade':trade,
                               ...
                               success: function(response)
                               {
                                    ...
                                    // $('#first_chart_div').html(response[0]);
                                    ...
                                    $('#buysell_div').html(response[1]);
                                    $('#tradehistory_div').html(response[2]);
                                    $('#order_history_div').html(response[3]);
                                    $('#submit_form_div').html(response[4]);
