<?php
    ...
    API::add('Transactions','get24hData',array(51,27)); //IOX
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $iox_usd = $checkusd['IOX']['last_price'] * $user_balances_iox;
    $usdt_usd = $checkusd['USDT']['last_price'] * $user_balances_usdt;

    $totalBalance = $zec_usd + $user_balances_usd + $btc_usd + $bch_usd + $eth_usd + $ltc_usd + $iox_usd; + $usdt_usd;
    $fiatBalance = $user_balances_usd;
    $cryptoBalance = $zec_usd + $btc_usd + $bch_usd + $eth_usd + $ltc_usd + $iox_usd + $usdt_usd;
                            ...
                            <table  style="margin:0px !important;" class="table row-border info-data-table table-hover balance-table table-border" cellspacing="0 " width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td>
                                           <img src="images/IOX.png">
                                            <span style="position: relative;top: -7px;">Paxlox</span>
                                        </td>
                                        <td style="text-align:right">
                                            <h5 style="margin-bottom: 0px;">$ <?= $transactions_24hrs_iox_usd['lastPrice'] ? $transactions_24hrs_iox_usd['lastPrice'] : '0.00'; ?></h5>
                                            <span>+<? echo $transactions_24hrs_iox_usd['transactions_24hrs'] ? $transactions_24hrs_iox_usd['transactions_24hrs'] : '0.00'; ?>%</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="images/usdt.jpg">
                                            <span style="position: relative;top: -7px;">Tether</span>
                                        </td>
                                        <td style="text-align:right">
                                            <h5 style="margin-bottom: 0px;">$ <? echo $transactions_24hrs_usdt_usd['lastPrice'] ? $transactions_24hrs_usdt_usd['lastPrice'] : '0.00'; ?></h5>
                                            <span>+<? echo $transactions_24hrs_usdt_usd['transactions_24hrs'] ? $transactions_24hrs_usdt_usd['transactions_24hrs'] : '0.00'; ?>%</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table id="info-data-table " class="table row-border info-data-table table-hover balance-table table-border" cellspacing="0 " width="100% ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td> <img src="images/IOX.png"></td>
                                        <td><a href="">IOX<span class="name">(Paxlox)</span></a></td>
                                        <td><?= Stringz::currency($user_balances_iox,true) ?> IOX</td>
                                        <!-- <td>$<?=Stringz::currency($transactions_24hrs_iox_usd['lastPrice'] * Stringz::currency($user_balances_iox,true)); ?></td> -->
                                        <td>
                                            <a href="cryptowalletnew?c_currency=50" class="outline-btn">Deposit</a>
                                            <a href="cryptowalletnew?c_currency=50" class="outline-btn">Withdraw</a>
                                            <a href="userbuy?trade=XMR-USD" class="outline-btn">Trade</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="images/usdt.jpg" style="width:20px; height:20px;"></td>
                                        <td><a href="">USDT<span class="name">(Tether)</span></a></td>
                                        <td><?= Stringz::currency($user_balances_usdt,true) ?> USDT</td>
                                        <!-- <td>$<?= Stringz::currency($transactions_24hrs_usdt_usd['lastPrice'] * Stringz::currency($user_balances_usdt,true)); ?></td> -->
                                                                                <td>
											<a href="cryptowalletnew?c_currency=51" class="outline-btn">Deposit</a>
                                            <a href="cryptowalletnew?c_currency=51" class="outline-btn">Withdraw</a>
                                            <a href="userbuy?trade=LTC-USDT" class="outline-btn">Trade</a>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            ...
                                            if($currency=="USDT")
                                                { ?>
                                                <img src="images/usdt.jpg" style="width:20px; height:20px;">
                                                <?
                                            }
...
<img src="http://paxion.io/images/banner4.jpg">
