<meta charset="utf-8">
   ...
   <link rel="apple-touch-icon" sizes="57x57" href="sonance/img/favicon/apple-icon-57x57.png">
    ...
    <!-- Color Switch -->
    <link rel="stylesheet" href="bitniex/css/jquery.colorpanel.css">
    <!-- Default Style CSS -->
    <link rel="stylesheet" type="text/css" href="bitniex/css/default.css">
    <link rel="stylesheet" type="text/css" href="bitniex/css/responsive.css">
    <!-- Color Skin -->
    <link rel="stylesheet" type="text/css" id="cpswitch" href="bitniex/css/skins/default.css">


    <!-- Sonance Template Copied  -->
