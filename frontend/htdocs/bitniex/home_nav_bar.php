 ...
 <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="index">
                ...
                <img class="logo" src="images/logo1.png" alt="" style="filter: invert(100%);">
            </a>
            <div class="collapse navbar-collapse justify-content-md-center" id="navbarToggler">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="exchange_ui?trade=POLY-USD&c_currency=52&currency=27"><span class="name">STO EXCHANGE</span></a>
                    </li>
                ...
                <?php 
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="openorders?c_currency=52&currency=27">
                               MY OPEN ORDERS
                            </a>
                            <a class="dropdown-item" href="tradehistory">
                                MY TRADE HISTORY
                            </a>
                            <a class="dropdown-item" href="alltradehistory">
                                TRADE HISTORY
                            </a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="manageaccounts">
