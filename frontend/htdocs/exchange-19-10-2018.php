                            ...
                            <div class="form-box">
                                ...
                                <div class="form-inner1">
                                    <div class="content">
                                        ...
                                        <p class="text-right">
                                       <input type="submit" name="submit" value="<?= str_replace('[c_currency]',$c_currency_info['currency'],Lang::string('buy-bitcoins')) ?>" class="Flex__Flex-fVJVYW ghkoKS buy-btc btn btn-light buy_form_btn"> </p>
