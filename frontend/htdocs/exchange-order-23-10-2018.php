                            ...
                            <div class="chart-hilights">
                                <div class="row">
                                    ...
                                    <div class="low no-border">
                                        ...
                                        <div class="info"><?= number_format($low24price, 8) ?> <?= $c_currency_info['currency'] ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-usd" role="tabpanel" aria-labelledby="r-usd-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=IOX-USDT&c_currency=50&currency=51">
                                                        <td>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BTC-USDT&c_currency=28&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                     ...
                                                     <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ETH-USDT&c_currency=45&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BCH-USDT&c_currency=44&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=LTC-USDT&c_currency=42&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ZEC-USDT&c_currency=43&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-btc" role="tabpanel" aria-labelledby="r-btc-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=IOX-BTC&c_currency=50&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ETH-BTC&c_currency=45&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BCH-BTC&c_currency=44&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=LTC-BTC&c_currency=42&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ZEC-BTC&c_currency=43&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=USDT-BTC&c_currency=51&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-ltc" role="tabpanel" aria-labelledby="r-ltc-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BTC-LTC&c_currency=28&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ETH-LTC&c_currency=45&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ZEC-LTC&c_currency=43&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BCH-LTC&c_currency=44&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=USDT-LTC&c_currency=51&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=IOX-LTC&c_currency=50&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-bch" role="tabpanel" aria-labelledby="r-bch-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BTH-BCH&c_currency=28&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ETH-BCH&c_currency=45&currency=44">
                                                        <td>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ZEC-BCH&c_currency=43&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=LTC-BCH&c_currency=42&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=IOX-BCH&c_currency=50&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=USDT-BCH&c_currency=51&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-zec" role="tabpanel" aria-labelledby="r-zec-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BTC-ZEC&c_currency=28&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=LTC-ZEC&c_currency=42&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ETH-ZEC&c_currency=45&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BCH-ZEC&c_currency=44&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=IOX-ZEC&c_currency=50&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=USDT-ZEC&c_currency=51&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-eth" role="tabpanel" aria-labelledby="r-eth-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTH' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BTC-ETH&c_currency=28&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=IOX-ETH&c_currency=50&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row" data-href="exchange-order?trade=BCH-ETH&c_currency=44&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left" style="font-size:9px">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=LTC-ETH&c_currency=42&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ZEC-ETH&c_currency=43&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=USDT-ETH&c_currency=51&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-iox" role="tabpanel" aria-labelledby="r-iox-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row" data-href="exchange-order?trade=BCH-IOX&c_currency=44&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left" style="font-size:9px">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=LTC-IOX&c_currency=42&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTH' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=BTC-IOX&c_currency=28&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ZEC-IOX&c_currency=43&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=ETH-IOX&c_currency=45&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <!-- <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="exchange-order?trade=USDT-IOX&c_currency=51&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
 ...
 <script type="text/javascript" src="js/ops_new1.js?v=20160210"></script>
  <script>
    ...
    <script>
        ...
        function order_stop_sell_confirm()
        {
            var c_currency='<?php echo $_REQUEST['c_currency']; ?>';
            var currency='<?php echo $_REQUEST['currency']; ?>';
            var trade='<?php echo $market; ?>';
            ...
            var ref_status=$('#ref_status').val();    
            var bonus_amount=$('#bonus_amount').val(); 
            var ischecked= $('#is_referral_sell').is(':checked');
            if(ischecked) 
            { 
                var is_referral=1;   
            }
        ...
        function order_limit_buy_confirm()
        {
            var c_currency='<?php echo $_REQUEST['c_currency']; ?>';
            var currency='<?php echo $_REQUEST['currency']; ?>';
            var trade='<?php echo $market; ?>';
        ...
        function order_limit_sell_confirm()
        {
            var c_currency='<?php echo $_REQUEST['c_currency']; ?>';
            var currency='<?php echo $_REQUEST['currency']; ?>';
            var trade='<?php echo $market; ?>';
            ...
            var sell=1;
            var limit_sell=1;
            var ref_status=$('#ref_status_sell').val();
            var bonus_amount=$('#bonus_amount').val(); 
            var ischecked= $('#is_referral_sell').is(':checked');
            if(ischecked) 
            { 
        ...
        function order_stop_sell_cancel()
        {
            var c_currency='<?php echo $_REQUEST['c_currency']; ?>';
            var currency='<?php echo $_REQUEST['currency']; ?>';
            var trade='<?php echo $market; ?>';
        ...
        function order_limit_buy_cancel()
        {
            var c_currency='<?php echo $_REQUEST['c_currency']; ?>';
            var currency='<?php echo $_REQUEST['currency']; ?>';
            var trade='<?php echo $market; ?>';
        ...
        function order_limit_sell_cancel()
        {
            var c_currency='<?php echo $_REQUEST['c_currency']; ?>';
            var currency='<?php echo $_REQUEST['currency']; ?>';
            var trade='<?php echo $market; ?>';
