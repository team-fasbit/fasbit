                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="form-box">
                                <div class="form-head">
                                    ...
                                    <p>You have : <span id="buy_user_available" style="/* color: #2f8afd; */"><?= ((!empty($user_available[strtoupper($currency_info['currency'])])) ? Stringz::currency($user_available[strtoupper($currency_info['currency'])],($currency_info['is_crypto'] == 'Y')) : '0.00') ?></span> <span class="sell_currency_label"><?= $currency_info['currency'] ?></span></p>
                                    <p>You have : <span id="sell_user_available" style="/* color: #2f8afd; */"  ><?= Stringz::currency($user_available[strtoupper($c_currency_info['currency'])],true) ?></span> <?= $c_currency_info['currency']?></p>
                                </div>
                                    ...
                                    ?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="stop-buy" class="tab-pane <?= $stopbuy_active ?>">
                                                <form id="buy_form" action="exchange.php?trade=<?= $market ?>&c_currency=<?= $_REQUEST['c_currency'] ?>&currency=<?= $_REQUEST['currency'] ?>&stopbuy=1" method="POST">
...
<!--                                         <div class="input-group mb-3">
                                        ...
                                        <?php /*if($REFERRAL == true){ ?>
                                            ...
                                            <!-- End of Stop-limit buy referral -->
                                                ...
                                                <input type="button" name="submit" value="Buy" class="Flex__Flex-fVJVYW ghkoKS buy-btc btn btn-light">
                                ...
                                <!-- Stop buy form confirmed -->
                                            ...
                                            <? else: ?>
                                                  <form id="confirm_form" action="exchange.php?trade=<?= $market ?>&c_currency=<?= $_REQUEST['c_currency'] ?>&currency=<?= $_REQUEST['currency'] ?>" method="POST">
                        ...
                        <!-- Stop sell form initial -->
                                            ...
                                            <div id="stop-sell" class="tab-pane <?= $stopsell_active ?>">
                                                <form id="sell_form" action="exchange.php?trade=<?= $market ?>&c_currency=<?= $_REQUEST['c_currency'] ?>&currency=<?= $_REQUEST['currency'] ?>&stopsell=1" method="POST">
                                                       <?php
                                    ...
                                    <div class="col-md-12" style="margin: auto;width: 100%;padding: 0;display: <?= $stopsell_display?>">
                                        ...
                                        <p class="text-right">
                                             <input type="hidden" name="sell" value="1" />
                                                ...
                                                <input type="button" name="submit" value="<?= str_replace('[c_currency]',$c_currency_info['currency'],Lang::string('sell-bitcoins')) ?>" class="Flex__Flex-fVJVYW ghkoKS buy-btc btn btn-light">                                                 
                                            <?php
                                        }else{
                                            ?>
                                            <style>
                                ...
                                <!-- Stop sell form confirmed -->
                                 ...
                                 <? else: ?>
                                        ...
                                        <form id="confirm_form" action="exchange.php?trade=<?= $market ?>&c_currency=<?= $_REQUEST['c_currency'] ?>&currency=<?= $_REQUEST['currency'] ?>&stopbuy=1" method="POST">
                                                    <input type="hidden" name="confirmed" value="1" />
                                                    <input type="hidden" id="buy_all" name="buy_all" value="<?= $buy_all1 ?>" />
                                                    <input type="hidden" id="cancel" name="cancel" value="" />
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <? if(!$ask_confirm) : ?>
                                <form id="buy_form" action="exchange.php?trade=<?= $market ?>&c_currency=<?= $_REQUEST['c_currency'] ?>&currency=<?= $_REQUEST['currency'] ?>&buy=1" method="POST">
                                <input type="hidden" id="is_crypto" value="<?= $currency_info['is_crypto'] ?>" />
                        <?php
                        if (($ref_response != 0 && $c_currency_id != 50) || ($ref_response == 0 && $c_currency_id != 50) || ($ref_response == 0 && $c_currency_id == 50)) { ?>
                        <input type="hidden" id="user_fee" value="<?= $user_fee_both['fee'] ?>" />
                        ...
                        <? else: ?>
                             <form id="confirm_form" action="exchange.php?trade=<?= $market ?>&c_currency=<?= $_REQUEST['c_currency'] ?>&currency=<?= $_REQUEST['currency'] ?>&buy=1" method="POST">
                                                    <input type="hidden" name="confirmed" value="1" />
                                                    <input type="hidden" id="buy_all" name="buy_all" value="<?= $buy_all1 ?>" />
                                                    <input type="hidden" id="cancel" name="cancel" value="" />
                            <div class="form-box">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <? if(!$ask_confirm1) : ?>
                            <div class="form-box">
                                <form id="sell_form" action="exchange.php?trade=<?= $market ?>&c_currency=<?= $_REQUEST['c_currency'] ?>&currency=<?= $_REQUEST['currency'] ?>&sell=1" method="POST">
                                <div class="form-head">
                                     <?php
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-usd" role="tabpanel" aria-labelledby="r-usd-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=IOX-USDT&c_currency=50&currency=51">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs__iox_usdt['lastPrice'], 2)  ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs__iox_usdt['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=BTC-USDT&c_currency=28&currency=51">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_btc_usd['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_btc_usd['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                     <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=ETH-USDT&c_currency=45&currency=51">
                                                        ...
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_eth_usd['lastPrice'],8) ?></span> </td>
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_eth_usd['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=BCH-USDT&c_currency=44&currency=51">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_bch_usd['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_bch_usd['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=LTC-USDT&c_currency=42&currency=51">
                                                        ...
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_ltc_usd['lastPrice'],8) ?></span> </td>
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_ltc_usd['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=ZEC-USDT&c_currency=43&currency=51">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_zec_usd['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_zec_usd['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-btc" role="tabpanel" aria-labelledby="r-btc-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=IOX-BTC&c_currency=50&currency=28">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_iox_btc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_iox_btc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=ETH-BTC&c_currency=45&currency=28">
                                                        ...
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_eth_btc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_eth_btc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=BCH-BTC&c_currency=44&currency=28">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_bch_btc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_bch_btc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=LTC-BTC&c_currency=42&currency=28">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_ltc_btc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_ltc_btc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=ZEC-BTC&c_currency=43&currency=28">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_zec_btc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_bch_btc['change_24hrs'],8) ?></span></td>
                                                    </tr>                                                    
                                            ...
                                            <div class="tab-pane fade <?php echo $class_active;?>" id="r-ltc" role="tabpanel" aria-labelledby="r-ltc-tab">
                                                <table class="table row-border table-hover" cellspacing="0" width="100%">
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=BTC-LTC&c_currency=28&currency=42">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_btc_ltc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_btc_ltc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=ETH-LTC&c_currency=45&currency=42">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_eth_ltc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_eth_ltc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=ZEC-LTC&c_currency=43&currency=42">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_zec_ltc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_zec_ltc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=BCH-LTC&c_currency=44&currency=42">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_bch_ltc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_bch_ltc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="exchange?trade=IOX-LTC&c_currency=50&currency=42">
                                                        ...
                                                        <td><span class="green-color"><?= number_format($transactions_24hrs_iox_ltc['lastPrice'],8) ?></span> </td>
                                                        <td><span class="red-color"><?= number_format($transactions_24hrs_iox_ltc['change_24hrs'],8) ?></span></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
