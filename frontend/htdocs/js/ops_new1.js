...
function calculateBuy() {
	$('#buy_amount,#buy_price,#buy_stop_price,#buy_amount11,#sell_amount,#sell_price,#sell_stop_price,#sell_amount11').bind("keyup change", function () {
		calculateBuyPrice();
	});
	...
	$('#buy_amount,#buy_amount11,#buy_price,#sell_amount,#sell_price,#fiat_amount,#btc_amount,#buy_stop_price,#sell_stop_price,#sell_amount11').bind("keypress", function (e) {
	...
	$('#buy_amount,#buy_amount11,#buy_price,#sell_amount,#sell_price,#fiat_amount,#btc_amount,#buy_stop_price,#sell_stop_price,#sell_amount11').focus(function () {
		if (!(parseFloat($(this).val()) > 0))
			$(this).val('');
	});

	$('#buy_amount,#buy_amount11,#buy_price,#sell_amount,#sell_price,#fiat_amount,#btc_amount,#buy_stop_price,#sell_stop_price').blur(function () {
		if (!(parseFloat($(this).val()) > 0))
			$(this).val('0');
	});
...
function calculateBuyPrice(all) {
	...
	var buy_amount11 = ($('#buy_amount11').val()) ? parseFloat($('#buy_amount11').val().replace(tho, '')) : 0;
	...
	var buy_subtotal11 = buy_amount11 * (($('#buy_stop').is(':checked') ) ? buy_stop_price : buy_price);
	
	var buy_commision = (buy_fee * 0.01) * buy_subtotal;
	var buy_commision11 = (buy_fee * 0.01) * buy_subtotal11;
	//
	...
	//
	if(buy_subtotal == 0){
		var buy_total = buy_subtotal11 + buy_commision11;
		$('#buy_total1').val(formatCurrency(buy_total, ($('#is_crypto').val() == 'Y')));
	}else{
		
		var buy_total = buy_subtotal + buy_commision;
		$('#buy_total').val(formatCurrency(buy_total, ($('#is_crypto').val() == 'Y')));
		$('#buy_total').html(formatCurrency(buy_total, ($('#is_crypto').val() == 'Y')));
	}
	
	console.log("User fee "+user_fee);
	console.log("User fee1 "+user_fee1);
	// console.log("User buy_total "+buy_total);
	// console.log("User buy_subtotal "+buy_subtotal);
	// console.log("User buy_commision "+buy_commision);
	// console.log("User first_ask "+first_ask);
	// console.log("User buy_amount "+buy_amount);
	// console.log("User buy_price "+buy_price);
	console.log("User buy_total123654 "+formatCurrency(buy_total, ($('#is_crypto').val() == 'Y')));
	console.log("User buy_stop_price "+buy_stop_price);
	console.log("User buy_amount11 "+buy_amount11);
	console.log("User buy_subtotal11 "+buy_subtotal11);
	...
	var sell_amount11 = ($('#sell_amount11').val()) ? parseFloat($('#sell_amount11').val().replace(tho, '')) : 0;
	...
	var sell_subtotal11 = sell_amount11 * (($('#sell_stop').is(':checked')) ? sell_stop_price : sell_price);
	
	var sell_commision = (sell_fee * 0.01) * sell_subtotal;
	var sell_commision11 = (sell_fee * 0.01) * sell_subtotal11;
	...
	if(sell_subtotal == 0){
		var sell_total = sell_subtotal11 - sell_commision11;
		// $('#buy_total1').val(formatCurrency(buy_total, ($('#is_crypto').val() == 'Y')));
		$('#sell_total1').val(formatCurrency(sell_total, ($('#is_crypto').val() == 'Y')));
	}else{
		
		var sell_total = sell_subtotal - sell_commision;
		// $('#buy_total').val(formatCurrency(buy_total, ($('#is_crypto').val() == 'Y')));
		$('#sell_total').val(formatCurrency(sell_total, ($('#is_crypto').val() == 'Y')));
	}
	
	
	
	// console.log("User sell_total "+sell_total);
	// console.log("User sell_subtotal "+sell_subtotal);
	// console.log("User sell_commision "+sell_commision);
	// console.log("User first_bid "+first_bid);
	// console.log("User sell_amount "+sell_amount);
	// console.log("User sell_price "+sell_price);
	// console.log("User sell_subtotal123654 "+formatCurrency(sell_total, ($('#is_crypto').val() == 'Y')));
	// console.log("User sell_amount11 "+sell_amount11);
	// console.log("User sell_subtotal11 "+sell_subtotal11);
	// console.log("User sell_total "+sell_total);
	// console.log("User first_bid "+first_bid);
...
function calculateBuyPrice_stop_limit_buy(all) {
	...
	var buy_stop_price = ($('#buy_stop_price').val()) ? parseFloat($('#buy_stop_price').val().replace(tho, '')) : 0;
	var buy_fee = (buy_price >= first_ask || $('#buy_market_price').is(':checked')) ? user_fee : user_fee1;
	var buy_subtotal = buy_amount * (($('#buy_stop').is(':checked')) ? buy_stop_price : buy_price);
	var buy_subtotal11 = buy_amount11 * (($('#buy_stop').is(':checked') ) ? buy_stop_price : buy_price);
...
function calculateBuyPrice_stop_limit_sell(all) {
	...
	var sell_subtotal = sell_amount * (($('#sell_stop').is(':checked')) ? sell_stop_price : sell_price);
	var sell_subtotal11 = sell_amount11 * (($('#sell_stop').is(':checked')) ? sell_stop_price : sell_price);
...
function calculateBuyPrice_buy(all) {
	var bonus_amount = $("#bonus_amount").val();	
...
function calculateBuyPrice_sell(all) {
	var bonus_amount = $("#bonus_amount").val();	
	...
	var sell_subtotal = sell_amount * ((!$('#sell_limit').is(':checked')) ? sell_stop_price : sell_price);
	var sell_subtotal11 = sell_amount11 * (($('#sell_stop').is(':checked')) ? sell_stop_price : sell_price);
	
	var sell_commision = (sell_fee * 0.01) * sell_subtotal;
	var sell_commision11 = (sell_fee * 0.01) * sell_subtotal11;

	var ref_status_sell = $("#ref_status_sell").val();
	if (ref_status_sell == 1 || ref_status_sell == "1") {
		if(document.getElementById('is_referral_sell').checked) {
		    if (parseFloat(bonus_amount) > parseFloat(sell_commision)) {
				sell_commision = parseFloat(0); 
			} else {
