                    ...
                    <div class="register-box">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="email" name="login[user]" value="demo@bitexchange.cash" placeholder="Email" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <!-- <span class="input-group-addon"><i class="fas fa-key"></i></span> -->
                                <input class="form-control" type="password" name="login[pass]" value="12345678" placeholder="Password" required>
                            </div>
                        </div>
