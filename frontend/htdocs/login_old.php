...
.register-card button.btn.btn-primary {
    background-color: #007bff !important;
}
.register-card .note span.pull-right {
    color: white;
}
.register-card .note a {
    ...
    <?php 
        ...
        body.register-page {
    background-image: url(http://paxion.io/images/banner3.jpg);
                    ...
                    <form method="POST" action="login" name="login">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="email" name="login[user]" placeholder="Email">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
