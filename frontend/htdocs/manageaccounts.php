...
if ($account1 > 0) {
    ...
    if (!is_array(Errors::$errors)) {
        ...
        $params = array($account1,$currency1,$description1,$ifsc_code, $bank_name, $name);
        API::add('BankAccounts','insert',$params);
        //API::add('BankAccounts','get');
        $query = API::send();
        API::add('BankAccounts','get');
        $query = API::send();
        ...
        Link::redirect('manageaccounts?show=add');
        $bank_accounts = $query['BankAccounts']['get']['results'][0];
    }
}
...
$_SESSION["bankaccount_uniq"] = md5(uniqid(mt_rand(),true));
    ...
    ?>
<head>
    <title><?= $CFG->exchange_name; ?> | Account Activities</title>
                    ...
                    <div class="profile-box">
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                ...
                                <form id="add_deposit" action="manageaccounts" method="POST">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <br>
                                <h6 class="card-title"><strong>Your Bank Accounts</strong>
                                 <span class="float-right">
