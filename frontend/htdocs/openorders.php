...
<html lang="en">
 <?php 
        ...
        API::add('Orders','getAllOrders',array(false,false,false,$c_currency1,$currency1,1,false,1,$order_by1,false,1));
        // API::add('Orders','get',array(false,false,false,$c_currency1,$currency1,1,false,false,$order_by1,1,1));
        $query = API::send();
        // print_r($query);
        $bids = $query['Orders']['getAllOrders']['results'][0];
        ...
        ?>
<head>
    <title><?= $CFG->exchange_name; ?> | Open Orders</title>
                    ...
                    <div class="order-table-box">
                        <div class="row">
                            <div class="col-md-12 col-xs-12 text-center">
                                ...
                                <table class="table row-border table-hover order-data-table" cellspacing="0 " width="100% ">
                                    <thead>
                                        <tr>
                                            <th>Type</th>
                                            <th>Buy/Sell</th>
                                    ...
                                    <tbody>
                                        ...
                                        echo '<tr id="no_bids" style="'.(is_array($bids) && count($bids) > 0 ? 'display:none;' : '').'"><td colspan="5">No Buy Ordes to show</td></tr>';
                                        ?>
