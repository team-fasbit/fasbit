...
?>
<?php if($buy && $_REQUEST['limit_sell']!=1 && $_REQUEST['limit_buy']==1) { ?>
<div class="" id="limit_buy">
                        ...
                        <div class="">
                            ...
                            <div class="form-box form2-box" style="margin-bottom: 26px;">
                                ...
                                <?php if(($sell && $_REQUEST['limit_sell']!=1 && $_REQUEST['limit_buy']!=1) || ($sell && $_REQUEST['limit_sell']!=1 && $_REQUEST['limit_buy']!=1)) { ?>
                                <div class="form-head">
                                    <?php
                                ...
                                <div class="form-head">
                                    ...
                                    <div class="col-md-12" style="margin: auto;width: 100%;padding: 0;display: <?= $sell_display?>">
                                        ...
                                        <style>
                                            ...
                                            div#limit_sell .form-box.form2-box,div#limit_sell .clear {
    											display: none;
											}
                                        </style>
                                        <?= ($notice) ? '<div class="notice">'.$notice.'</div>' : '' ?>
