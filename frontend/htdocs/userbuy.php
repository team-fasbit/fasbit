...
// ini_set('display_errors', 1);
    ...
    $transactions_24hrs_iox_usd = $query['Transactions']['get24hData']['results'][36] ;
    $transactions_24hrs_iox_btc = $query['Transactions']['get24hData']['results'][37] ;
    $transactions_24hrs_iox_ltc = $query['Transactions']['get24hData']['results'][38] ;
    $transactions_24hrs_iox_bch = $query['Transactions']['get24hData']['results'][39] ;
    $transactions_24hrs_iox_zec = $query['Transactions']['get24hData']['results'][40] ;
    $transactions_24hrs_iox_eth = $query['Transactions']['get24hData']['results'][41] ;

    $transactions_24hrs_usdt_usd = $query['Transactions']['get24hData']['results'][42] ;
    $transactions_24hrs_usdt_btc = $query['Transactions']['get24hData']['results'][43] ;
    $transactions_24hrs_usdt_ltc = $query['Transactions']['get24hData']['results'][44] ;
    $transactions_24hrs_usdt_bch = $query['Transactions']['get24hData']['results'][45] ;
    $transactions_24hrs_usdt_zec = $query['Transactions']['get24hData']['results'][46] ;
    $transactions_24hrs_usdt_eth = $query['Transactions']['get24hData']['results'][47] ;
    $transactions_24hrs_usdt_iox = $query['Transactions']['get24hData']['results'][48] ;

    $transactions_24hrs_btc_usdt = $query['Transactions']['get24hData']['results'][49] ;
    $transactions_24hrs_ltc_usdt = $query['Transactions']['get24hData']['results'][50] ;
    $transactions_24hrs_bch_usdt = $query['Transactions']['get24hData']['results'][51] ;
    $transactions_24hrs_zec_usdt = $query['Transactions']['get24hData']['results'][52] ;
    $transactions_24hrs_eth_usdt = $query['Transactions']['get24hData']['results'][53] ;
    $transactions_24hrs_iox_usdt = $query['Transactions']['get24hData']['results'][54] ;
                                          ...
                                          <li class="nav-item">
                                            <?php
                                                if($active_currency_id == 51)
                                                    ...
                                                    $class_active = "";
                                            ?>
                                            <a class="nav-link <?php echo $class_active;  ?>" id="r-usdt-tab" data-toggle="tab" href="#r-usdt" role="tab" aria-controls="r-usdt" aria-selected="false">USDT</a>
                                        </li>
                                    </ul>
                                            ...
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'USD') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-USD&c_currency=43&currency=27">
                                                     ...
                                                     <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'USD') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=IOX-USD&c_currency=50&currency=27">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="green-color"><?= $transactions_24hrs_iox_usd['lastPrice'] ?></span> </td>
                                                        <td><span class="red-color"><?= $transactions_24hrs_iox_usd['change_24hrs'] ?></span></td>
                                                    </tr>
                                                     <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'USD') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=USDT-USD&c_currency=51&currency=27">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="green-color"><?= $transactions_24hrs_usdt_usd['lastPrice'] ?></span> </td>
                                                        <td><span class="red-color"><?= $transactions_24hrs_usdt_usd['change_24hrs'] ?></span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-BTC&c_currency=43&currency=28">
                                                       ...
                                                       <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=IOX-BTC&c_currency=50&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="red-color"><?= $transactions_24hrs_iox_btc['lastPrice'] ?></span> </td>
                                                        <td><span class="green-color"><?= $transactions_24hrs_iox_btc['change_24hrs'] ?></span></td>
                                                    </tr>
                                                       <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=USDT-BTC&c_currency=51&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="red-color"><?= $transactions_24hrs_usdt_btc['lastPrice'] ?></span> </td>
                                                        <td><span class="green-color"><?= $transactions_24hrs_usdt_btc['change_24hrs'] ?></span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BCH-LTC&c_currency=44&currency=42">
                                                      ...
                                                      <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=IOX-LTC&c_currency=50&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                      ...
                                                      <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=USDT-LTC&c_currency=51&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                            ...
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=LTC-BCH&c_currency=42&currency=44">
                                                      ...
                                                      <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=IOX-BCH&c_currency=50&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                      ...
                                                      <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=USDT-BCH&c_currency=51&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-zec" role="tabpanel" aria-labelledby="r-zec-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=IOX-ZEC&c_currency=50&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=USDT-ZEC&c_currency=51&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-eth" role="tabpanel" aria-labelledby="r-eth-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-ETH&c_currency=43&currency=45">
                                                     ...
                                                     <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=IOX-ETH&c_currency=50&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                     ...
                                                     <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=USDT-ETH&c_currency=51&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                         ...
                                         <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-iox" role="tabpanel" aria-labelledby="r-iox-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTH' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BTC-IOX&c_currency=28&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=LTC-IOX&c_currency=42&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BCH-IOX&c_currency=44&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left" style="font-size:9px">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-IOX&c_currency=43&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ETH-IOX&c_currency=45&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'USDT' && $currency_info['currency'] == 'IOX') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=USDT-IOX&c_currency=51&currency=50">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-usdt" role="tabpanel" aria-labelledby="r-usdt-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BTC-USDT&c_currency=28&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="green-color"><?= $transactions_24hrs_btc_usdt['lastPrice'] ?></span> </td>
                                                        <td><span class="red-color"><?= $transactions_24hrs_btc_usdt['change_24hrs'] ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=LTC-USDT&c_currency=42&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="red-color"><?= $transactions_24hrs_ltc_usdt['lastPrice'] ?></span> </td>
                                                        <td><span class="green-color"><?= $transactions_24hrs_ltc_usdt['change_24hrs'] ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ETH-USDT&c_currency=45&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="red-color"><?= $transactions_24hrs_eth_usdt['lastPrice'] ?></span> </td>
                                                        <td><span class="green-color"><?= $transactions_24hrs_eth_usdt['change_24hrs'] ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BCH-USDT&c_currency=44&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="green-color"><?= $transactions_24hrs_bch_usdt['lastPrice'] ?></span> </td>
                                                        <td><span class="red-color"><?= $transactions_24hrs_bch_usdt['change_24hrs'] ?></span></td>
                                                    </tr>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-USDT&c_currency=43&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="green-color"><?= $transactions_24hrs_zec_usdt['lastPrice'] ?></span> </td>
                                                        <td><span class="red-color"><?= $transactions_24hrs_bch_usdt['change_24hrs'] ?></span></td>
                                                    </tr>
                                                     <tr class="clickable-row <?= ($c_currency_info['currency'] == 'IOX' && $currency_info['currency'] == 'USDT') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=IOX-USDT&c_currency=50&currency=51">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                        ...
                                                        <td><span class="green-color"><?= $transactions_24hrs_iox_usdt['lastPrice'] ?></span> </td>
                                                        <td><span class="red-color"><?= $transactions_24hrs_iox_usdt['change_24hrs'] ?></span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
